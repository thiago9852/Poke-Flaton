(() => {
    function initPokemonSearch() {
        // ==========================================
        // AUTOCOMPLETE DROPDOWN (Usado na Home)
        // ==========================================
        ...
        if (autocompleteInput && resultsContainer && searchDataEl) {
            if (!autocompleteInput.dataset.searchInitialized) {
                autocompleteInput.dataset.searchInitialized = 'true';
        ...
        if (gridContainer && gridForm && gridSearchInput) {
            if (!gridForm.dataset.filterInitialized) {
                gridForm.dataset.filterInitialized = 'true';
                let gridTimeoutId;
    ...
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', initPokemonSearch);
    } else {
        initPokemonSearch();
    }
    document.addEventListener('turbo:load', initPokemonSearch);
})();